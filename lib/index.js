...
Fastly.prototype.deleteDomain = function (service, version, domain, callback) {
  var url = '/service/' + encodeURIComponent(service) + '/version/' + encodeURIComponent(version) + '/domain/' + encodeURIComponent(domain);
...
Fastly.prototype.deleteDictionaryItem = function (service, dictionary, key, callback) {
  var url = '/service/' + encodeURIComponent(service) + '/dictionary/' + encodeURIComponent(dictionary) + '/item/' + encodeURIComponent(key);
  this.request('DELETE', url, callback);
};
